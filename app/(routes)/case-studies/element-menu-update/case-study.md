...
## Enhancing the element menu with contextual help and educational resources
...
This case study explores how introducing contextual education into the content creation experience to guide users to create effective messages and send broadcasts more confidently.

## Observations and insight

### Voice of the Customer
Throughout 2023, NPS surveys revealed a consistent theme: customers wanted more educational resources and guidance within the platform. Each quarterly survey reinforced this need:

- **Q1 2023**: Initial feedback highlighted confusion around certain editor features
- **Q2 2023**: UI/UX focused surveys showed customers specifically requesting more in-context help
- **Q3 2023**: Continued emphasis on education needs, particularly for newer features
- **Q4 2023**: Key takeaways pointed directly to the need for integrated guidance during content creation

### Contextual Help Pattern Success
Throughout 2024, implemention of contextual help patterns in other areas of the application provided promising results:

- Areas with contextual guidance showed higher feature adoption rates
- Support tickets related to features with integrated help decreased
- User confidence, measured through task completion rates, increased in sections with clear guidance
...
## Solution: Three Key innovations through iteration
...
This minimalist design created several challenges:
- Users struggled to understand the purpose and capabilities of different elements
- The relationship between elements was unclear
- There was no contextual guidance to help users make appropriate choices
- Learning was dependent on external resources or trial and error
...
## Outcomes and Impact
The Element Menu Update has delivered significant improvements in both quantitative metrics and qualitative user experience:

### Key Benefits
- **Accelerated Learning**: New users reach proficiency with the editor significantly faster, reducing the time from sign-up to first successful campaign
- **Feature Discovery**: Existing users are discovering and utilizing advanced features they were previously unaware of
- **Confidence Building**: Users report higher confidence in their ability to create effective content, leading to more ambitious projects
- **Reduced Friction**: The integrated guidance has eliminated key points of friction in the content creation workflow
- **Support Efficiency**: Support staff can focus on more complex issues as basic editor questions have decreased
...
The Element Menu Update project has reinforced several key principles about effective user education:

- **Context is crucial**: Education is most effective when delivered at the moment of need, directly within the workflow
- **Progressive disclosure**: Information should be layered, with basic guidance immediately available and deeper content accessible on demand
- **Show, don't just tell**: Interactive demonstrations and examples are more effective than text descriptions alone
- **Personalization matters**: Users have different needs and learning styles; effective guidance adapts to these differences
- **Continuous improvement**: User education is never "complete" – it requires ongoing refinement based on user feedback and behavior
