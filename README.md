...
Product designer with 12+ years of experience shipping user-centered digital products across SaaS, e-commerce, healthcare, and entertainment. Currently leading agentic design at AWeber, directing AI agents and engineers to build production experiences for 100,000+ businesses. I work primarily in code and live prototypes, bridging design and engineering to ensure intent translates accurately to shipped features.
...
### Sr. Product Designer
**AWeber** · Jan 2026 – Present · Chalfont, PA

Directing agentic design at scale for 100,000+ businesses

Lead designer for AWeber's agentic content builders and workflow tools, directing AI agents and engineers to ship production experiences. Own the design infrastructure, including agent guidelines, component patterns, and documentation, that enables consistent, scalable UI across AI-powered features. Champion customer needs through research and data-driven iteration, working primarily in code and live prototypes rather than static mockups.
...
### Sr. UI Designer
**AWeber** · Nov 2022 – Jan 2026 · Chalfont, PA

Leading design innovation for email marketing platform serving 100,000+ businesses

Strategic design leader responsible for AWeber's content creation product suite, including Message Editor, Landing Page Editor, and Campaign Builder. Led mobile design initiatives and emerging AI product development while mentoring junior designers and co-leading the company's design system. Balanced independent end-to-end design ownership with hands-on implementation and development.

- Led complete redesign of Campaign Builder to Workflow Builder, reducing workflow creation time by approximately 25% and transforming complex automation tool into streamlined user experience for 100,000+ customers — [View Case Study](docs/case-studies/new-workflows-builder.md)
...
- Spearheaded mobile optimization strategy for content creation tools, establishing responsive design patterns adopted across product suite — [View Case Study](docs/case-studies/mobile-editing-experience.md)
...
### UI Designer
**AWeber** · Sep 2019 – Nov 2022 · Chalfont, PA

Modernizing content creation tools through accessibility-first design

Designed user interfaces and interactions for AWeber's content creation tools, focusing on email and landing page editors. Facilitated user research initiatives and delivered accessible, production-ready features while collaborating with cross-functional teams in an agile environment. Contributed to product development through both design leadership and hands-on implementation.

- Redesigned Message Editor and Landing Page Editor, increasing mobile editing sessions by 22% and modernizing core product experiences used by thousands of customers daily — [View Case Study](docs/case-studies/friendlier-content-editor.md)
...
**Synchrony Group** · Aug 2016 – Aug 2018 · West Chester, PA

Leading digital strategy and design for healthcare and pharmaceutical clients

Led interactive design and development for medical, pharmaceutical, and healthcare clients, establishing digital best practices and creative direction company-wide. Independently designed and developed websites and interactive experiences while providing strategic guidance to leadership on digital initiatives. Served as primary creative resource for both client work and internal company redesigns.
...
### Contracted Interactive Designer
**QVC** · May 2016 – Aug 2016 · West Chester, PA

Delivering high-volume e-commerce creative in fast-paced entertainment environment

Designed e-commerce and email marketing assets for high-volume retail environment, supporting product conversion campaigns across digital channels. Collaborated with cross-functional teams including e-commerce, marketing, and on-air entertainment in fast-paced, deadline-driven atmosphere.
